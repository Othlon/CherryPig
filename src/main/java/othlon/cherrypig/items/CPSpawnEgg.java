 ...
 */
public class CPSpawnEgg extends ItemMonsterPlacer {


    @SideOnly(Side.CLIENT)
    private IIcon theIcon;
    protected int colorBase = 0x990000;
    protected int colorSpots = 0x669900;
    ...
    public CPSpawnEgg(String parEntityToSpawnName, int parPrimaryColor,
    ...
    public Entity spawnEntity(World parWorld, double parX, double parY, double parZ)
    {
        ...
        {
            entityToSpawnNameFull = CherryPig.MODID+"."+entityToSpawnName;
