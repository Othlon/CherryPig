...
public class CherryTreeFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {

    public CherryTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225796_1_) {
        super(p_i225796_1_);
    }
